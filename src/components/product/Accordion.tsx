  ...
  return (
    ...
    >
      <summary className="flex cursor-pointer list-none items-center justify-between gap-4 py-4 text-[0.98rem] font-medium text-ink transition-colors hover:text-maroon [&::-webkit-details-marker]:hidden">
        ...
        <span
          aria-hidden
          className="chevron grid size-7 shrink-0 place-items-center rounded-full border border-ink/15 text-ink-soft transition-transform duration-400 ease-[cubic-bezier(0.16,1,0.3,1)]"
        >
      ...
      <div className="pb-6 text-[0.87rem] leading-relaxed text-ink-soft">{children}</div>
    </details>
  );
}
